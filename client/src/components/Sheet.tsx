...
export default function Sheet({ onClose, maxHeight = "84%", children }: { onClose: () => void; maxHeight?: string; children: ReactNode }) {
  return (
    <div style={{ position: "absolute", inset: 0, background: "rgba(32,30,29,0.42)", display: "flex", flexDirection: "column", justifyContent: "flex-end", zIndex: 30 }}>
      <div style={{ background: "var(--color-bg)", borderRadius: "28px 28px 0 0", maxHeight, overflow: "auto", padding: "14px 20px 30px", boxShadow: "var(--shadow-lg)" }}>
