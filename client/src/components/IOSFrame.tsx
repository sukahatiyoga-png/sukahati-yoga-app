...
// Permanent device chrome around the app, ported from project/ios-frame.jsx
// (the prototype's preview-only iPhone bezel) into a real, always-on shell.
...
export default function IOSFrame({ children }: { children: ReactNode }) {
  return (
    <div
      style={{
