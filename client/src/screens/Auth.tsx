...
export default function Auth({ onAuthed }: { onAuthed: () => void }) {
  ...
  return (
    <div style={{ position: "relative", height: "100dvh", width: "100%", maxWidth: 480, margin: "0 auto", overflow: "hidden", background: "#2a1d14" }}>
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column", overflowY: "auto", WebkitOverflowScrolling: "touch" }}>
        <div style={{ flex: "0 0 48%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", paddingTop: 34 }}>
